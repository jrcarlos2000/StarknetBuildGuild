  ...
  useEffect(() => {
    async function AsyncFn() {
      if (filteredProject) {
        ...
        if (poolInfoResult)
          setAmountFunded(await parseAmountFunded(poolInfoResult));
      }
    }
    AsyncFn();
        ...
        <ProjectInfo>
          ...
          <ButtonContainer>
            <Link href="/">
              <CodeButton
                onClick={() => {
                  window.open(filteredProject.repoUrl);
                }}
              >
                Code
                <BiLinkExternal />
            ...
            <Link href="/">
              <DemoButton
                onClick={() => {
                  window.open(filteredProject.liveDemoUrl);
                }}
              >
                Live Demo
                <BiLinkExternal />
          ...
          <Description>
            {amountFunded
              ? `funded with ${amountFunded} Ether`
              : "not funded yet"}
          </Description>
        </ProjectInfo>
        <Account />
